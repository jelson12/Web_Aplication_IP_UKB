        ...
        <div class="row g-5">
            ...
            <div class="col-lg-6 col-xl-3">
                <div class="footer-item-4">
                    <h4 class="mb-4 text-white">Nossa galeria</h4>
                    <div class="row g-2">
                        <div class="col-4">
                            <div class="rounded overflow-hidden">
                                <img src="{{asset('assets/img/footer-1.jpg')}}" class="img-zoomin img-fluid rounded w-100" alt="">
                            </div>
                       </div>
                       <div class="col-4">
                            <div class="rounded overflow-hidden">
                                <img src="{{asset('assets/img/footer-2.jpg')}}" class="img-zoomin img-fluid rounded w-100" alt="">
                            </div>
                       </div>
                        <div class="col-4">
                            <div class="rounded overflow-hidden">
                                <img src="{{asset('assets/img/footer-3.jpg')}}" class="img-zoomin img-fluid rounded w-100" alt="">
                            </div>
                       </div>
                        <div class="col-4">
                            <div class="rounded overflow-hidden">
                                <img src="{{asset('assets/img/footer-4.jpg')}}" class="img-zoomin img-fluid rounded w-100" alt="">
                            </div>
                       </div>
                        <div class="col-4">
                            <div class="rounded overflow-hidden">
                                <img src="{{asset('assets/img/footer-5.jpg')}}" class="img-zoomin img-fluid rounded w-100" alt="">
                            </div>
                       </div>
                       <div class="col-4">
                        <div class="rounded overflow-hidden">
                            <img src="{{asset('assets/img/footer-6.jpg')}}" class="img-zoomin img-fluid rounded w-100" alt="">
                        </div>
                   </div>
                    </div>
                </div>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-6 my-auto text-center text-md-end text-white">
                ...
                Designed By <a class="border-bottom" href="https://htmlcodex.com">DJW</a>
            </div>
        </div>
    </div>
</div>
