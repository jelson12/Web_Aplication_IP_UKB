...
<div class="container-fluid py-5">
    <div class="container py-5">
        <ol class="breadcrumb justify-content-start mb-4">
            ...
            <li class="breadcrumb-item active text-dark">Artigos</li>
        </ol>
        <div class="row g-4">
            <div class="col-lg-8">
                <div class="mb-4">
                ...
                <div class="d-flex justify-content-between">
                    <a href="#" class="text-dark link-hover me-3"><i class="fa fa-clock"></i>Lido há 06 minutos</a>
                    <a href="#" class="text-dark link-hover me-3"><i class="fa fa-eye"></i> 3.5k visualizações</a>
                    <a href="#" class="text-dark link-hover me-3"><i class="fa fa-comment-dots"></i> 05 comentários</a>
                    <a href="#" class="text-dark link-hover"><i class="fa fa-arrow-up"></i> 1.5 mil partilhas</a>
                </div>
                ...
                <div class="tab-class">
                    <div class="d-flex justify-content-between border-bottom mb-4">
                        ...
                        <div class="d-flex align-items-center">
                            <h5 class="mb-0 me-3">Partilha:</h5>
                        ...
                        <div class="col-lg-6">
                            <div class="d-flex align-items-center p-3 bg-white rounded">
                                ...
                                <div class="ms-3">
                                    ...
                                    <p class="text-dark mt-3 mb-0 me-3"><i class="fa fa-clock"></i> 06 minutos read</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-6">
