...
<div class="p-6 container-fluid">
    ...
    <div class="align-items-center row">
        <div class="col-xl-12 col-lg-12 col-md-12 col-12">
            <div class="card">
                <div class="card-body">
                    <div class="pt-20 rounded-top" style="background-image:url('{{ asset('assets/img/profile-cover.jpg') }}') background-size: cover; background-repeat: no-repeat;">
                    </div>
                            ...
                            <div class="d-flex align-items-center">
                                <div
                                    ...
                                    <img src="{{asset('assets/img/footer-2.jpg')}}" class="img-zoominimg-fluid rounded-circle w-100" alt=""
                                        ...
                                        href="/pages/profile#!"><img src="{{asset('assets/img/checked-mark.svg')}}" alt=""
                                            height="30" width="30" class=""></a></div>
                                <div class="lh-1">
                                    <h2 class="mb-0">Jitu Chauhan<a class="text-decoration-none" data-bs-toggle="tooltip"
                                            ...
                                            <form method="post" action="">
                                                ...
                                                <div class="mb-3">
                                                    ...
                                                    <input type="text" class="form-control" id="paginas"
                                                        aria-describedby="emailHelp" name="paginas" value="" required>
            ...
            <div class="mb-6 col-xl-6 col-lg-12 col-md-12 col-12">
                <div class="card">
                    ...
                    <div class="d-grid">
                        ...
                        data-bs-target="#artigoModal">Postar artigo</button>
                    </div>
                    <div class="modal fade" id="artigoModal" tabindex="-1" aria-labelledby="artigoModalLabel" aria-hidden="true">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                <div class="modal-header">
